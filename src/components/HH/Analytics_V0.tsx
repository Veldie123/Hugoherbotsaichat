        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          <Card className="p-4 sm:p-6 rounded-[16px] shadow-hh-sm border-hh-border">
            <div className="flex items-start justify-between mb-3 sm:mb-4">
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-hh-success/10 flex items-center justify-center">
                <Target className="w-4 h-4 sm:w-5 sm:h-5 text-hh-success" />
              </div>
              <div
                className={`flex items-center gap-0.5 sm:gap-1 text-[12px] sm:text-[14px] ${
            ...
            <p className="text-[12px] leading-[16px] sm:text-[14px] sm:leading-[20px] text-hh-muted mb-1">
              Overall Score
            </p>
            <p className="text-[28px] leading-[36px] sm:text-[32px] sm:leading-[40px] text-hh-text font-[700]">
          ...
          <Card className="p-4 sm:p-6 rounded-[16px] shadow-hh-sm border-hh-border">
            <div className="flex items-start justify-between mb-3 sm:mb-4">
              ...
              <div className="flex items-center gap-0.5 sm:gap-1 text-[12px] sm:text-[14px] text-hh-success">
                <TrendingUp className="w-3 h-3 sm:w-4 sm:h-4" />
          ...
          <Card className="p-4 sm:p-6 rounded-[16px] shadow-hh-sm border-hh-border">
            <div className="flex items-start justify-between mb-3 sm:mb-4">
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-hh-warn/10 flex items-center justify-center">
                <Award className="w-4 h-4 sm:w-5 sm:h-5 text-hh-warn" />
              </div>
              <div className="flex items-center gap-0.5 sm:gap-1 text-[12px] sm:text-[14px] text-hh-success">
                <TrendingUp className="w-3 h-3 sm:w-4 sm:h-4" />
          ...
          <Card className="p-4 sm:p-6 rounded-[16px] shadow-hh-sm border-hh-border">
            <div className="flex items-start justify-between mb-3 sm:mb-4">
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-hh-ui-100 flex items-center justify-center">
                <Calendar className="w-4 h-4 sm:w-5 sm:h-5 text-hh-text" />
              </div>
              <div className="flex items-center gap-0.5 sm:gap-1 text-[12px] sm:text-[14px] text-hh-success">
                <TrendingUp className="w-3 h-3 sm:w-4 sm:h-4" />
            ...
            <p className="text-[24px] leading-[32px] sm:text-[32px] sm:leading-[40px] text-hh-text font-[700]">
