      ...
      <div className="p-6 space-y-6">
            ...
            return (
              <Card key={kpi.label} className="p-4 sm:p-5 rounded-[16px] shadow-hh-sm border-hh-border">
                <div className="flex items-start justify-between mb-2 sm:mb-3">
                  <div className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full ${kpi.bgColor} flex items-center justify-center`}>
            ...
            <div className="space-y-3">
              {recentNotifications.map((notification) => {
                ...
                return (
                  <div 
                    key={notification.id} 
                    className="flex items-start gap-3 p-3 rounded-lg bg-blue-50/50 hover:bg-blue-50 transition-colors cursor-pointer"
        ...
        <Card className="p-6 rounded-[16px] shadow-hh-sm border-hh-border">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
            <Button
              className="justify-start gap-3 h-auto py-4 bg-red-600 hover:bg-red-700"
