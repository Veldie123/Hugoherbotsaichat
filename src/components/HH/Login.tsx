      ...
      <div className="min-h-screen flex pt-16 sm:pt-20">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8">
          <div className="w-full max-w-md">
            ...
            {/* Mobile: Social Proof - Visible only on mobile */}
            <div className="mt-8 pt-6 border-t border-hh-border lg:hidden">
              <p className="text-center text-[13px] leading-[18px] text-hh-muted mb-3">
                Vertrouwd door 20.000+ professionals
              </p>
              <div className="flex items-center justify-center gap-6 text-[12px] leading-[16px] text-hh-muted">
                <div className="flex items-center gap-1.5">
                  <Check className="w-4 h-4 text-hh-success" />
                  <span>40 jaar expertise</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <Check className="w-4 h-4 text-hh-success" />
