...
import { MessageSquare, FileAudio, ChevronRight, BarChart3, Clock, TrendingUp, Mic } from "lucide-react";
...
export function HistorySidebar({ type, items, onSelectItem, onOpenFullView }: HistorySidebarProps) {
  ...
  return (
    <div 
      className={`
        hidden lg:flex flex-col h-full border-r border-hh-border bg-white transition-all duration-300 ease-in-out relative
    ...
    >
      {!isExpanded ? (
        ...
        <div className="flex flex-col h-full overflow-hidden">
          <div className="p-4 border-b border-hh-border bg-gradient-to-r from-hh-bg to-white">
