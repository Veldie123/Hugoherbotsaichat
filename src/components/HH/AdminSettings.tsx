      ...
      <div className="p-6 space-y-6">
        ...
        <Tabs defaultValue="general" className="space-y-6">
          <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2">
            <TabsTrigger value="general" className="flex items-center justify-center gap-1 sm:gap-2 px-2 sm:px-4">
              <SettingsIcon className="w-4 h-4 flex-shrink-0" />
              <span className="text-xs sm:text-sm truncate">Algemeen</span>
            </TabsTrigger>
            ...
            <TabsTrigger value="integrations" className="flex items-center justify-center gap-1 sm:gap-2 px-2 sm:px-4">
              <Link2 className="w-4 h-4 flex-shrink-0" />
              <span className="text-xs sm:text-sm truncate">Integraties</span>
            </TabsTrigger>
            <TabsTrigger value="notifications" className="flex items-center justify-center gap-1 sm:gap-2 px-2 sm:px-4">
              <Bell className="w-4 h-4 flex-shrink-0" />
              <span className="text-xs sm:text-sm truncate">Notificaties</span>
            </TabsTrigger>
            <TabsTrigger value="admins" className="flex items-center justify-center gap-1 sm:gap-2 px-2 sm:px-4">
              <Users className="w-4 h-4 flex-shrink-0" />
              <span className="text-xs sm:text-sm truncate">Admins</span>
            </TabsTrigger>
          </TabsList>
