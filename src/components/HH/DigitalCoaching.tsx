...
interface DigitalCoachingProps {
  ...
  isAdmin?: boolean;
  noLayout?: boolean; // NEW: Allow rendering without layout wrapper
}

export function DigitalCoaching({ navigate, isAdmin, noLayout }: DigitalCoachingProps) {
                ...
                <div key={phase.nummer} className="mb-1">
                  ...
                  >
                    ...
                    <Badge variant="outline" className={`text-[10px] flex-shrink-0 ${
                      isSpecial ? "bg-purple-600 text-white border-purple-600" : ""
                    }`}>
                      {phase.nummer}
                    </Badge>
                    ...
                    {phase.nummer === "∞" && (
                      <Button 
                        size="sm" 
                        className="h-6 px-2 text-[11px] bg-purple-600 hover:bg-purple-700"
                        onClick={(e) => {
                          e.stopPropagation();
                          startTraining(phase);
                        }}
