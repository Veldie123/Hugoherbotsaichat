    ...
    <NotificationProvider>
      ...
      {!isCheckingAuth && (
        <>
          ...
          {currentPage === "talk-to-hugo" && <TalkToHugoAI key={navigationData?.sessionId || navigationData?.conversationId || 'default'} navigate={navigate} isAdmin={isAdmin} navigationData={navigationData} />}
