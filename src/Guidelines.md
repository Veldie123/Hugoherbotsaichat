...
### Color Conventions - User View vs Admin View
**User View (AppLayout, Coaching, RolePlay):**
- Primary buttons: **Steel Blue** (`#0EA5E9`) - Ocean blue voor CTA's
- Hugo's messages: **Deep Blue** (`#0F172A`) - Donker blauw voor Hugo's antwoorden
- Active states: Steel blue accents
- Overall feel: Modern, clean, professioneel

**Admin View (AdminLayout, AdminChatExpertMode, Admin pages):**
- Dominant color: **Purple** (`#8B5CF6`, `purple-600`) - Paarse primary buttons en badges
- Fase badges: Purple (`bg-purple-100 text-purple-700 border-purple-300`)
- Selected techniques: Purple (`bg-purple-50 text-purple-800 border border-purple-300`)
- Recommended techniques: Light purple (`bg-purple-50/30 border border-purple-200`)
- Hugo's messages in admin: Purple (`bg-purple-600 text-white`)
- Chat/message icons: Purple (`text-purple-600 hover:text-purple-700`)
- Primary action buttons: Purple (`bg-purple-600 hover:bg-purple-700`)
- Overall feel: Expert mode, training environment, pedagogische focus

**Rationale:**
- User view = salesmedewerkers die role-plays doen → steel blue = trustworthy, professioneel
- Admin view = trainers/beheerders die AI model trainen → paars = advanced, expert tools
- Consistente kleurscheiding zorgt voor duidelijke context awareness
