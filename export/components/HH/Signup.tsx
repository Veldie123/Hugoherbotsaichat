...
export function Signup({ onLoginClick, onSignupSuccess, navigate }: SignupProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 3. Fetch workspaces (optional - don't fail signup if this fails)
      try {
        ...
        if (workspacesResponse.ok) {
          ...
          console.warn('⚠️ Failed to fetch workspaces (non-critical):', workspacesResponse.status);
        }
      } catch (workspaceErr: any) {
        console.warn('⚠️ Network error fetching workspaces (non-critical):', workspaceErr.message);
        // Continue anyway - workspace will be loaded on next page
      }
      ...
      <div className="min-h-screen flex pt-16 sm:pt-20">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8">
          <div className="w-full max-w-md">
            ...
            {/* Mobile: Trust Badges & Stats - Visible only on mobile */}
            <div className="mt-8 pt-6 border-t border-hh-border lg:hidden space-y-4">
              {/* Stats */}
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  <p className="text-[24px] leading-[32px] font-semibold text-hh-text">40+</p>
                  <p className="text-[11px] leading-[16px] text-hh-muted">Jaar training</p>
                </div>
                <div>
                  <p className="text-[24px] leading-[32px] font-semibold text-hh-text">20K+</p>
                  <p className="text-[11px] leading-[16px] text-hh-muted">Getraind</p>
                </div>
                <div>
                  <p className="text-[24px] leading-[32px] font-semibold text-hh-text">€2K</p>
                  <p className="text-[11px] leading-[16px] text-hh-muted">Live/halve dag</p>
                </div>
              </div>
              ...
              <div className="text-center">
                <p className="text-[13px] leading-[18px] text-hh-muted">
                  Live training: <span className="line-through">€2.000</span> → Nu: <span className="text-hh-primary font-semibold">€149/mnd</span>
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-hh-ink text-white items-center justify-center relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-lg px-12 text-center">
            ...
            <div className="grid grid-cols-3 gap-8 mt-12 mb-12">
              ...
              <div>
                <p className="text-[36px] leading-[44px] mb-1">€2K</p>
