...
export function TechniqueDetailsDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-xl max-h-[85vh] overflow-y-auto bg-white p-0 rounded-2xl">
        {/* Header */}
        ...
        {/* Footer */}
        <DialogFooter className="p-6 pt-4 border-t border-hh-border/50 flex-row justify-between gap-3">
          {isEditing ? (
            <>
              <Button
